...
@section('title', 'Categorie Prodotto')
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-danger btn-block btn-sm js-delete"
                            data-list="table_list" data-url="{{ route('product-categories.delete') }}">
...
$(document).ready(function () {
    ...
    $(document).on('click', '.btn_edit', function () {
        var url = "{{ route('product-categories.show', ['_id_']) }}";
    ...
    $("#table_list").DataTable({
        ...
        ajax: {
            type: 'POST',
            url: '{{ route('product-categories.datatable') }}',
