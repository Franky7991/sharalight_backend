...
@section('title', 'Modifica Causale')
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('causals.update', [$causal->id]) }}">
            @csrf
            @method('PUT')
            @if ($errors->any())
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="name" name="name" value="{{ $causal->name }}"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select id="type" name="type" class="form-control" required>
                            ...
                            @foreach($causalTypes as $value => $label)
                                <option value="{{ $value }}" {{ $causal->type === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
