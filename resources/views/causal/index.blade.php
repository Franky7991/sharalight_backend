                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-danger btn-block btn-sm js-delete"
                            data-list="table_list" data-url="{{ route('causals.delete') }}">
                            <i class="fa fa-trash"></i> Cancella
                        </button>
                    </div>
                    <div class="col-3">
                        <a href="{{ route('causals.create') }}">
...
$(document).ready(function () {
    ...
    $(document).on('click', '.btn_edit', function () {
        var url = "{{ route('causals.show', ['_id_']) }}";
