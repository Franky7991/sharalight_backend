...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('unit-of-measures.update', [$unitOfMeasure->id]) }}">
            @csrf
            @method('PUT')
            @if ($errors->any())
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="name" name="name" value="{{ $unitOfMeasure->name }}" class="form-control" placeholder="Nome" required>
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="symbol" name="symbol" value="{{ $unitOfMeasure->symbol }}" class="form-control" placeholder="Simbolo" required>
                    </div>
                </div>
                <div class="col-12">
                    <div class="row">
