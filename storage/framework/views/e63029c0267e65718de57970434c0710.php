...
<?php $__env->startSection('title', 'Modifica Categoria Prodotto'); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('product-categories.update', [$productCategory->id])); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="name" name="name" value="<?php echo e($productCategory->name); ?>"
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select id="unit_of_measure_id" name="unit_of_measure_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $unitOfMeasures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($uom->id); ?>" <?php echo e($productCategory->unit_of_measure_id == $uom->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project\shara_light\backend\resources\views\product_category\show.blade.php ENDPATH**/ ?>