        ...
        <div class="card">
            <div class="card-header p-0">
                <ul class="nav nav-tabs" id="productTabs" role="tablist">
                    ...
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo e($product->hasRecipe() ? '' : 'active'); ?>" id="tab-price-history"
            ...
            <div class="card-body">
                <div class="tab-content" id="productTabsContent">
                    ...
                    <?php endif; ?>
                    <div class="tab-pane fade <?php echo e($product->hasRecipe() ? '' : 'show active'); ?>"
                        id="pane-price-history" role="tabpanel">
                        <?php echo $__env->make('product.tabs.price_history', ['product' => $product], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function () {
    ...
    $("#table_price_history").DataTable({
        ...
        ajax: {
            type: 'POST',
            url: '<?php echo e(route('products.price-histories.datatable', $product->id)); ?>',
