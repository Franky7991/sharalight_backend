...
<div class="card">
    <div class="card-header pb-0">
        <h4 class="mb-0">Modifica Utente</h4>
    </div>
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('users.update', [$user->id])); ?>">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <label for="password">Password <small class="text-muted">(lascia vuoto per non cambiare)</small></label>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project\shara_light\backend\resources\views\user\show.blade.php ENDPATH**/ ?>