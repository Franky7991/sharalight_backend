                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <button type="button" class="btn btn-danger btn-block btn-sm js-delete"
                            data-list="table_list" data-url="<?php echo e(route('causals.delete')); ?>">
                            <i class="fa fa-trash"></i> Cancella
                        </button>
                    </div>
                    <div class="col-3">
                        <a href="<?php echo e(route('causals.create')); ?>">
...
$(document).ready(function () {
    ...
    $(document).on('click', '.btn_edit', function () {
        var url = "<?php echo e(route('causals.show', ['_id_'])); ?>";
    ...
    $("#table_list").DataTable({
        ...
        ajax: {
            type: 'POST',
            url: '<?php echo e(route('causals.datatable')); ?>',
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project\shara_light\backend\resources\views/causal/index.blade.php ENDPATH**/ ?>