...
<?php $__env->startSection('title', 'Nuova Causale'); ?>
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('causals.store')); ?>">
            <?php echo csrf_field(); ?>
            <?php if($errors->any()): ?>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project\shara_light\backend\resources\views\causal\create.blade.php ENDPATH**/ ?>